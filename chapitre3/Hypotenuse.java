...
// 2ème appel de la fonction calculHypotenuse()
	...
	/*
	 * DEFINITION de la fonction membre calculHypotenuse() Fonction qui calcule la
	 * longueur de l'hypoténuse d'un triangle rectangle : - 1er paramètre : longueur
	 * du 1er coté - 2ème paramètre : longueur du second coté - valeur de retour :
	 * l'hypoténuse
	 */
